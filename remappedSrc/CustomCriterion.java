...
//     ID = new Identifier(ResourcePackRefresher.MOD_ID, status);
//   }
...
//   @Override
//   public final void beginTrackingCondition(PlayerAdvancementTracker playerAdvancementTracker,
//       ConditionsContainer<Conditions> conditionsContainer) {
//   }

//   @Override
//   public void endTrackingCondition(PlayerAdvancementTracker playerAdvancementTracker,
//       ConditionsContainer<Conditions> conditionsContainer) {
//   }
...
//   @Override
//   public Conditions conditionsFromJson(JsonObject jsonObject,
//       AdvancementEntityPredicateDeserializer advancementEntityPredicateDeserializer) {
//     return new Conditions(this.getId(),
//         LootContextPredicate.fromJson("player", advancementEntityPredicateDeserializer, jsonObject, null));
//   }
...
//         if (advancementCriterion.getConditions() != null
//             && advancementCriterion.getConditions().getId().equals(getId()))
...
//     public Conditions(Identifier identifier, LootContextPredicate extended) {
